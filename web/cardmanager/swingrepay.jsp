...
<head>
    ...
    <script type="text/javascript">
        ...
        function refreshswingrepayList(swingrepayList) {
            $('#swingrepaySummary').html(swingrepayList);
        }
    </script>
</head>
        ...
        <div class="panel-body" id="parentIframe">
            <form>
                <div style="height:100%; overflow:auto;">
                    <table class="table table-border table-bordered table-striped table-bg table-hover table-sort">
                        <thead>
                        <tr class="text-c">
                            <th><s:text name="personinfo.time"/></th>
...
<script>
    ...
    (laypage({
        ...
        jump: function (obj) {
            $.ajax({
                type: 'post',
                url: 'Bill!FetchSwingRepayList?currpage='+obj.curr,
                dataType:"json",
                ...
                success: function (data) {
                    ...
                    if (json.errorMessage != null) {
                        ...
                        refreshswingrepayList(json.swingrepaySummary);
                    }
                }
            })
        }
