    ...
    <form class="form form-horizontal">
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            <tr class="text-c odd" role="row">
                ...
                <td>
                    <input id="swingMoney" name="swingMoney" type="text" placeholder="<s:text name="swingcarddirectly.money" />" class="input-text size-S">
                </td>
            </tr>
            <tr class="text-c">
        ...
        <div class="row">
            <div class="formControls col-8 col-offset-3" align="center">
                <input type="button" class="btn btn-success radius size-M" value="<s:text name="global.submit" />" onclick="swingDirectly()">
            </div>
        </div>
    </form>
</div>
