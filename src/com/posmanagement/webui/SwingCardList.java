    ...
    public String generateTableList() throws Exception {
        ...
        for (int index = 0; index < dbRet.size(); ++index) {
            htmlString += new UIContainer("tr")
                   ...
                   // .addElement("td" ,StringUtils.convertNullableString(dbRet.get(index).get("RULENO")))
//                    .addElement(new UIContainer("td").addElement(new UIContainer("label","查看编号")
//                            .addAttribute("class" ,"label label-success radius")
//                            .addAttribute("title" ,StringUtils.convertNullableString(dbRet.get(index).get("RULENO")))))
