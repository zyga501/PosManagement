...
<head>
    ...
    <title><s:text name="addposserver.title" /></title>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (json.errorMessage != null) {
                        ...
                        parent.refreshPosServerList(json.posServerList);
                    }
                }
            })
        }
    ...
    <form class="form form-horizontal">
        ...
        <div class="row">
            <div class="formControls col-8 col-offset-3" align="center">
                <input type="button" class="btn btn-success radius size-M" value="<s:text name="addposserver.submit" />" onclick="addPosServer()">
            </div>
        </div>
    </form>
</div>
